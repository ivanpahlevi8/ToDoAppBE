...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20260503162957_create new team role table")]
    partial class createnewteamroletable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.ProjectModel", b =>
                {
                    ...
                    b.Property<string>("ProjectUserLeadId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ProjectUserLeadId");

                    b.ToTable("Projects");
                });

            modelBuilder.Entity("WebApplication1.Models.ProjectUserJunction", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebApplication1.Models.TeamModel", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.TeamRoleModel", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.TeamUserJunction", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("TeamUserJunction");
                });

            modelBuilder.Entity("WebApplication1.Models.ToDoModel", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.ProjectModel", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.UserModel", "ProjectUserLead")
                        .WithMany("Projects")
                        .HasForeignKey("ProjectUserLeadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProjectUserLead");
            ...
            modelBuilder.Entity("WebApplication1.Models.ProjectUserJunction", b =>
                {
                    b.HasOne("WebApplication1.Models.ProjectModel", "Project")
                        .WithMany("ProjectUserJunctions")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebApplication1.Models.UserModel", "User")
                        .WithMany("ProjectUsersJunction")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication1.Models.TeamModel", b =>
                {
                    b.HasOne("WebApplication1.Models.UserModel", "TeamUserLeader")
                        .WithMany("Teams")
                        .HasForeignKey("TeamLeader")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TeamUserLeader");
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.TeamUserJunction", b =>
                {
                    b.HasOne("WebApplication1.Models.TeamModel", "Team")
                        .WithMany("TeamUserJunction")
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebApplication1.Models.TeamRoleModel", "TeamRole")
                        .WithMany("TeamUserJunction")
            ...
            modelBuilder.Entity("WebApplication1.Models.ProjectModel", b =>
                {
                    b.Navigation("ProjectUserJunctions");
